...
export function CarrouselBannieres() {
  ...
  return (
    <div
      className="relative overflow-hidden rounded-[24px] border border-bordure bg-prune shadow-[0_2px_8px_rgb(60_45_74_/_0.06),0_30px_60px_-34px_rgb(60_45_74_/_0.4)]"
      role="region"
